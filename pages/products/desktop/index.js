...
const lapi = ({ data }) => {
  return (
    <>
      <Head>
        <title>VertechDigiCom - Desktop</title>
      ...
      <div className={styles.laptopcontainer}>
        <div className={styles.laptopbanner}>
          ...
          <div className={styles.banner_text}>
            <h1>Desktop Computer & 2-in-1 PCs</h1>
            <p>
              Shop the best Desktop from vertech Digicom. See top Desktop deals
              today.
            </p>
          </div>
        </div>
